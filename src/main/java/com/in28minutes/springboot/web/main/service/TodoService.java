package com.in28minutes.springboot.web.main.service;
...
import com.in28minutes.springboot.web.main.model.Todo;
...
public class TodoService {
	...
	static {
		...
		todos.add(new Todo(3, "admin", "Learn Kubernetes", new Date(), false));
		todos.add(new Todo(4, "admin", "Learn Docker", new Date(), false));
		todos.add(new Todo(5, "admin", "Learn OpenShift", new Date(), false));
	}
